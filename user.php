    ...
    <!-------- home panel ----------------------------->
         ...
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5>System Users</h5><a rel='facebox' href="adduser.php" ><button type="button" class="btn btn-primary btn-xs">Add User</button></a> <!-- <a href="deleteuser.php"><button type="button" class="btn btn-danger btn-xs">Delete user</button></a></div>-->
            </div>
