...
<div id="wrapper">
  ...
  <ul class="nav nav-pills">
    ...
    <li><a href="feedback.php"><span class="glyphicon glyphicon-list"></span>&nbsp;feedback</a></li>
    <li><a href="query1.php"><span class="glyphicon glyphicon-list"></span>&nbsp;Sort By Amount</a></li>
    <li><a href="query2.php"><span class="glyphicon glyphicon-list"></span>&nbsp;Search by Place</a></li>
    <li><a href="query3.php"><span class="glyphicon glyphicon-list"></span>&nbsp;Bill Between Dates</a></li>
  </ul>
<hr color="#999999" />
